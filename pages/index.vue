...
const universidades = [
  ...
  {
    carrera: 'Enfermería',
    universidad: 'U. Los lagos Puerto Montt',
    ultimo_seleccionado: 0,
    ultimo_matriculado: 624,
    ponderaciones: {
      ranking: 45,
      nem: 10,
      lectora: 15,
